                ...
                <div className="fixH"><div className="centerH">
                    ...
                    >
                        ...
                        <div className="Login_Button_Class">
                            <svg className="Rectangle_SignUp">
                                <rect
                                    ...
                                    strokeMiterlimit={4}
                                    shapeRendering="auto"
                                    className="Rectangle_SignUp_Class"
                                    rx={16}
                                    ry={16}
                                    x={0}
                                    y={0}
                        ...
                        <div className="Email_textf_Class">
                            ...
                            <svg className="baseline_email_white_18dp">
                                <pattern
                                    elementid="baseline_email_white_18dp_A3_Rectangle_4"
                                    id="baseline_email_white_18dp_A3_Rectangle_4_pattern"
                                    x={0}
                                    y={0}
                                    width="100%"
                                    height="100%"
                                ...
                                <rect
                                    fill="url(#baseline_email_white_18dp_A3_Rectangle_4_pattern)"
                        ...
                        <div className="pass_textf_Class">
                            <svg className="Rectangle_100_A3_Rectangle_5">
                                <rect
                                    fill="rgba(255,255,255,0.192)"
                                    stroke="rgba(112,112,112,1)"
                                    strokeWidth="1px"
                                    ...
                                    strokeMiterlimit={4}
                                    shapeRendering="auto"
                                    className="Rectangle_100_A3_Rectangle_5_Class"
                                    rx={12}
                                    ry={12}
                                    x={0}
                                    y={0}
                            ...
                            <svg className="baseline_lock_white_18dp">
                                <pattern
                                    elementid="baseline_lock_white_18dp_A3_Rectangle_7"
                                    id="baseline_lock_white_18dp_A3_Rectangle_7_pattern"
                                    x={0}
                                    y={0}
                                    width="100%"
                                    height="100%"
                                >
                                    <image
                                        ...
                                        xlinkHref={require("./baseline_lock_white_18dp.png")}
                                    />
                                </pattern>
                                <rect
                                    fill="url(#baseline_lock_white_18dp_A3_Rectangle_7_pattern)"
                        ...
                        <div className="Already_have_an_account__Sign__Class">
                        ...
                        <div className="pass_textf_A3_Group_6_Class">
                            <svg className="Rectangle_100_A3_Rectangle_8">
                                <rect
                                    fill="rgba(255,255,255,0.192)"
                                    stroke="rgba(112,112,112,1)"
                                    strokeWidth="1px"
                                    ...
                                    strokeMiterlimit={4}
                                    shapeRendering="auto"
                                    className="Rectangle_100_A3_Rectangle_8_Class"
                                    rx={12}
                                    ry={12}
                                    x={0}
                                    y={0}
                            ...
                            <div className="Confirm_Password_Class">
                                <span>Confirm Password</span>
                            </div>
                            <svg className="baseline_lock_white_18dp_A3_Rectangle_9">
                                <pattern
                                    elementid="baseline_lock_white_18dp_A3_Rectangle_10"
                                    id="baseline_lock_white_18dp_A3_Rectangle_10_pattern"
                                    x={0}
                                    y={0}
                                    width="100%"
                                    height="100%"
                                ...
                                <rect
                                    fill="url(#baseline_lock_white_18dp_A3_Rectangle_10_pattern)"
                                    className="baseline_lock_white_18dp_A3_Rectangle_9_Class"
                                    rx={0}
                                    ry={0}
                                    x={0}
                                    y={0}
