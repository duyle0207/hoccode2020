...
class ModelTaskEdit extends Component {
  ...
  componentDidMount() {
    axios.get(`http://localhost:8081/api/v1/auth/tasks/${this.props.id}`).then(res=>{
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <Button color="primary" onClick={this.saveMinitaskList}>Test list</Button>
